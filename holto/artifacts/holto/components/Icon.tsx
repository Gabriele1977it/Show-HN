/**
 * Feather-compatible icon component backed by react-native-svg SvgXml.
 * Zero font-loading dependency — renders identically on iOS, Android, and web.
 * API mirrors @expo/vector-icons Feather: <Icon name="check" size={16} color="#fff" />
 */
import React from "react";
import { SvgXml } from "react-native-svg";
import type { StyleProp, ViewStyle } from "react-native";

// ─── Icon path data (24×24 viewBox, Feather stroke style) ─────────────────────
...
const PATHS: Record<string, string> = {
  ...
  "coffee": `<path d="M18 8h1a4 4 0 010 8h-1"/><path d="M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/>`,
  ...
  "key": `<path d="M21 2l-2 2"/><path d="M14.5 9.5L19 5l0 0"/><path d="M15.5 7.5L18 10"/><path d="M11.39 11.61a5.5 5.5 0 11-7.78 7.78 5.5 5.5 0 017.78-7.78z"/><line x1="11.4" y1="11.6" x2="15.5" y2="7.5"/>`,
  ...
  "rotate-ccw": `<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 100 .49-3.5"/>`,
...
export function Icon({ name, size = 24, color = "#000", style }: IconProps) {
  ...
  // Sanitise color for XML (hex and rgb strings are safe; avoid injection)
  const safeColor = String(color).replace(/[<>"']/g, "");
  const xml = `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${safeColor}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${inner}</svg>`;
  return (
    <SvgXml
      xml={xml}
      width={size}
